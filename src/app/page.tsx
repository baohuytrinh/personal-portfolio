        ...
        <div className=" mx-auto py-4 mb-4 flex flex-col md:flex-row w-full justify-between items-center md:items-start">
          ...
          <div className="order-2 md:order-1 mt-5  md:mt-10 text-center md:text-left px-5 md:px-0"> 
            ...
            <header className=" md:mr-10 text-2xl md:text-4xl py-2 flex justify-center md:justify-center">
              <h1 className="mr-2 font-bold flex gap-1.5">Hi, I&apos;m Bao <GiDumplingBao /> </h1>
              {/* <p className="text-gray-300 text-xs flex justify-center items-center">
                {"(bow💥- hwee)"}
              </p> */}
            </header>
            
            <h1 className=" text-gray-400 md:text-justify text-start text-lg md:text-l top-1 mx-left flex justify-center md:justify-start px-0 md:px-2 py-2 mr-0 md:mr-10">
            I&apos;m a junior at UMass Amherst studying Computer Science with a minor in Mathematics, aspiring to grow as a Full-Stack Developer / Software Engineer by continuing to contribute to impactful projects and applying the skills I&apos;ve developed through prior internships.
            </h1>
